    ...
    projects: [
      {
        ...
        description: "Procureezy.com is AI sourcing copilot for hardware engineers to tackle the thousands of hours lost in sourcing per engineer per year.",
        technologies: [
          "Next.js", "TypeScript", "TailwindCSS", "Shadcn/ui", "Nuqs", "HonoJS", "OpenAPI", "Neon", "DrizzleORM", "Zod", "Clerk", "Vercel", "PostHog",
          "React", "Bun", "Docker", "Better Auth", "Langfuse", "LanggraphJS", "Vercel AI SDK", "Python"
        ],
        links: ["https://procureezy.com", "https://platform.procureezy.com", "https://search.procureezy.com"],
        achievements: [
      ...
      },
      {
        ...
        description: "Marketplace to rent kitchens and dining rooms of private homes",
      ...
      },
      {
        ...
        location: "Remote",
        description: "Designed and developed websites for early-stage startups, SMEs and non-profits.",
      ...
      },
      {
        ...
        description: "An eco-friendly e-commerce for sustainable men's products. (built as part of my master thesis)",
